...
public class MeetingManager {
    ...
    private HashMap<String, Meeting> meetingIdToMeeting = new HashMap<>();
     ...
     *
     * @param suggestedEdits int of the threshold for editing a Meeting.
     */
    public void setEditsThreshold(int suggestedEdits) {this.editsThreshold = suggestedEdits; }
     ...
     *
     * @param meetingIdToMeeting a HashMap of Meetings and corresponding Meeting ids.
     */
    public void setMeetingIdToMeeting(HashMap<String, Meeting> meetingIdToMeeting) {
