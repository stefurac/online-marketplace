...
public class Meeting {
     ...
     */
    public void setId(String suggestedId) { this.meetingId = suggestedId; }
     ...
     */
    public void setTime(LocalDate suggestedTime) { this.time = suggestedTime; }
     ...
     */
    public void setPlace(String suggestedPlace) { this.place = suggestedPlace; }

    /**
     * Gets whether or not it is a User's turn.
     * @return usersTurn
     */
    public boolean[] getUsersTurn() { return this.usersTurn; }

    /**
     * Sets the User's turns.
     * @param usersTurns the suggested turns.
     */
    public void setUsersTurns(boolean[] usersTurns) { this.usersTurn = usersTurns; }

    /**
     * Gets number of edits a User has made to a Meeting.
     * @return usersEditCount
     */
    public int[] getUsersEditCount() { return this.usersEditCount; }
    /**
